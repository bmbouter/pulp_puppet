...
class Module(FileContentUnit):
    ...
    unit_key_fields = ('name', 'version', 'author')
    ...
    meta = {
        ...
        'indexes': [
            {
                'fields': unit_key_fields, # TODO check that name doesn't have 2 indexes after upgrading. Maybe a migration is needed since -name was an index defined already.
                'unique': True
            },
        ],
    }
    ...
    @classmethod
    def whitelist_fields(cls, metadata):  # TODO have this class method instantiate an object
        """
